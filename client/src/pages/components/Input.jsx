  ...
  return (
    <div className={props.wrapperClassname}>
      <label 
        ...
        className={ `flex text-sm text-slate-700 ${props.labelClassname}` }
      >
        {props.fieldName}
      </label>
      <div className={ `mt-1 ` }>
        <input
          ...
          className="text-black shadow-sm focus:ring-cyan-500 focus:border-cyan-500 block w-full sm:text-sm 
          border-slate-700 rounded-md py-0.5 truncate pr-5"
